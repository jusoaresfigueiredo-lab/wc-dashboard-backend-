...
async function callClaude(prompt, googleToken) {
  ...
  const res = await fetch("https://api.anthropic.com/v1/messages", {
    ...
    body: JSON.stringify({
      ...
      max_tokens: 4000,
      system: "You are a team activity analyst for World Collective. You MUST respond with ONLY a raw JSON object. Do not write any text before or after the JSON. Do not use markdown. Do not use backticks. Start your response with { and end with }. Any other format will cause a critical system error.",
